...
use function Livewire\Volt\{state, on, layout};

state(['permissionMode' => false]);

on(['dispatch-permissionMode' => function () {
    $this->permissionMode = true;
}]);
?>

<!-- Add Role Drawer -->
<div id="drawer-create-role-default"
    class="fixed top-0 right-0 z-40 w-full h-screen max-w-xs p-4 overflow-y-auto transition-transform translate-x-full bg-white dark:bg-gray-800"
    tabindex="-1" aria-labelledby="drawer-label" aria-hidden="true">
    <h5 id="drawer-label"
        class="inline-flex items-center mb-6 text-sm font-semibold text-gray-500 uppercase dark:text-gray-400">
        New Product {{ $permissionMode }}</h5>
    <button type="button" data-drawer-dismiss="drawer-create-role-default" aria-controls="drawer-create-role-default"
    ...
    <form action="#">
        <div class="space-y-4">
            ...
            <div class="bottom-0 left-0 flex justify-center w-full pb-4 space-x-4 md:px-4 md:absolute">
                ...
                <button type="button" data-drawer-dismiss="drawer-create-role-default"
