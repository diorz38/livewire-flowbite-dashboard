...
<main>
                    ...
                    <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <span class="ml-1 text-gray-400 md:ml-2 dark:text-gray-500" aria-current="page">Role &
                                    Permissions</span>
                            </div>
                        </li>
                    </ol>
                </nav>
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Role & Permission
                </h1>
            </div>
            <div class="items-center justify-between block sm:flex md:divide-x md:divide-gray-100 dark:divide-gray-700">
                    ...
                    <form class="sm:pr-3" action="#" method="GET">
                        ...
                        <div class="relative w-48 mt-1 sm:w-64 xl:w-96">
                            <input type="text" name="email" id="products-search"
                                ...
                                placeholder="Search for role or permission">
                        </div>
                    </form>
                ...
                <div>
                    ...
                    <button id="createRoleButton"
                        ...
                        data-drawer-show="drawer-create-role-default" aria-controls="drawer-create-role-default"
                        data-drawer-placement="right"
                        @click="$wire.set('permissionMode', true)">
                        Add new Permission
                    </button>
    ...
    <div class="flex flex-row justify-between sm:flex-col">
        ...
        <div
            class="sticky bottom-0 right-0 p-4 bg-white border-t border-gray-200 sm:flex sm:justify-between dark:bg-gray-800 dark:border-gray-700">
            {{ $roles->links() }}
        </div>
