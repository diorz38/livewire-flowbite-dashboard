<main>
    ...
    <div class="px-12 mt-2 sm:-mx-6 lg:-mx-8">
        ...
        <div
            class="sticky bottom-0 items-center w-full p-4 bg-white border-t border-gray-200 sm:flex sm:justify-between dark:bg-gray-800 dark:border-gray-700">
            {{ $dataUser->links() }}
        </div>
