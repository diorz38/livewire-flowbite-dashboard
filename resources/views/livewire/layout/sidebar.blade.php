...
<aside id="sidebar"
    ...
    <div
        ...
        <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
            <div class="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                <ul class="pb-2 space-y-2">
                    ...
                    {{-- <li>
                    <a wire:navigate href="{{ route('kegiatan.index') }}"
                        class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700 ">
                        ...
                        <span class="ml-3" sidebar-toggle-item>Kegiatan</span>
                    </a>
                </li> --}}
                    <li>
                        <button type="button"
                        ...
                        @if(!in_array(Request::segment(1), ['crud'])){{ 'hidden' }}@endif">
                            <li>
                    ...
                    <li>
                        ...
                        <ul id="dropdown-pages" class="hidden py-2 space-y-2">
                            <li>
                                <a wire:navigate href="{{ route('page.pricing') }}"
                            ...
                            <li>
                                <a wire:navigate href="{{ route('page.maintenance') }}"
                            ...
                            <li>
                                <a wire:navigate href="{{ route('page.error404') }}"
                            ...
                            <li>
                                <a wire:navigate href="{{ route('page.error500') }}"
                    ...
                    <li>
                        ...
                        <ul id="dropdown-auth" class="hidden py-2 space-y-2">
                            <li>
                                <a wire:navigate href="{{ route('authentication.signin') }}"
                            ...
                            <li>
                                <a wire:navigate href="{{ route('authentication.signup') }}"
                                    class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Sign
                                    up</a>
                            </li>
                            <li>
                                <a wire:navigate href="{{ route('authentication.forgot-password') }}"
                            ...
                            <li>
                                <a wire:navigate href="{{ route('authentication.reset-password') }}"
                            ...
                            {{-- <li>
                            <a wire:navigate href="{{ route('authentication.profile-lock') }}"
                    ...
                    <li>
                        ...
                        <ul id="dropdown-playground" class="hidden py-2 space-y-2 ">
                            <li>
                                <a wire:navigate href="{{ route('playground.stacked') }}"
                            ...
                            <li>
                                <a wire:navigate href="{{ route('playground.sidebar') }}"
                                    class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 ">Sidebar</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <button type="button"
                            class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700
                            @if(in_array(Request::segment(1), ['admin'])){{ 'bg-gray-100 dark:bg-gray-400 hover:text-gray-900 dark:hover:text-white' }}@endif"
                            aria-controls="dropdown-admin" data-collapse-toggle="dropdown-admin">
                            <x-fwb-s-user-settings class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"/>
                        ...
                        @if(!in_array(Request::segment(1), ['admin'])){{ 'hidden' }}@endif">
                            ...
                            <li>
                                <a wire:navigate href="{{ route('admin.user') }}"
                                    class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 pl-11 dark:text-gray-200 dark:hover:bg-gray-700
                                    @if(in_array(Request::segment(2), ['user'])){{ 'bg-gray-100 dark:bg-gray-400 hover:text-gray-900 dark:hover:text-white' }}@endif">
                                    User
                                </a>
                            </li>
                        </ul>
                ...
                <div class="pt-2 space-y-2">
                    <a href="https://github.com/diorz38/livewire-flowbite-dashboard" target="_blank"
        ...
        <div class="absolute bottom-0 left-0 justify-center hidden w-full p-4 space-x-4 bg-white lg:flex dark:bg-gray-800"
            sidebar-bottom-menu>
            <a wire:navigate href="{{ route('profile.show') }}" data-tooltip-target="tooltip-profile"
                ...
                <x-fwb-o-profile-card class="w-6 h-6"/>
            </a>
            <a wire:navigate href="{{ route('settings') }}" data-tooltip-target="tooltip-settings"
                class="inline-flex justify-center p-2 text-gray-500 rounded cursor-pointer hover:text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white">
