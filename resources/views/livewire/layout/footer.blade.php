<div>
    <footer
        ...
        <div class="flex space-x-6 sm:justify-center">
            <a wire:navigate href="#" class="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">
    ...
    <p class="my-10 text-sm text-center text-gray-500">
        &copy; 2019-2023 <a wire:navigate href="https://flowbite.com/" class="hover:underline" target="_blank">Flowbite.com</a>. All
        rights reserved.
    </p>
</div>
