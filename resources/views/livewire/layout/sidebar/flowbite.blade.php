<li>
    ...
    @if(!in_array(Request::segment(1), ['crud'])){{ 'hidden' }}@endif">
        <li>
            <a wire:navigate href="{{ route('flowbite.crud.products') }}"
        ...
        <li>
            <a wire:navigate href="{{ route('flowbite.crud.users') }}"
                class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 pl-11 dark:text-gray-200 dark:hover:bg-gray-700
...
<li>
    <a wire:navigate href="{{ route('flowbite.apex.chart') }}"
        class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700 ">
        <svg class="w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
            fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"
            aria-hidden="true">
...
<li>
    ...
    <ul id="dropdown-pages" class="hidden py-2 space-y-2">
        <li>
            <a wire:navigate href="{{ route('flowbite.page.pricing') }}"
        ...
        <li>
            <a wire:navigate href="{{ route('flowbite.page.maintenance') }}"
        ...
        <li>
            <a wire:navigate href="{{ route('flowbite.page.error404') }}"
        ...
        <li>
            <a wire:navigate href="{{ route('flowbite.page.error500') }}"
...
<li>
    ...
    <ul id="dropdown-auth" class="hidden py-2 space-y-2">
        <li>
            <a wire:navigate href="{{ route('flowbite.authentication.signin') }}"
        ...
        <li>
            <a wire:navigate href="{{ route('flowbite.authentication.signup') }}"
                class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Sign
                up</a>
        </li>
        <li>
            <a wire:navigate href="{{ route('flowbite.authentication.forgot-password') }}"
        ...
        <li>
            <a wire:navigate href="{{ route('flowbite.authentication.reset-password') }}"
        ...
        {{-- <li>
        <a wire:navigate href="{{ route('flowbite.authentication.profile-lock') }}"
...
<li>
    ...
    <ul id="dropdown-playground" class="hidden py-2 space-y-2 ">
        <li>
            <a wire:navigate href="{{ route('flowbite.playground.stacked') }}"
        ...
        <li>
            <a wire:navigate href="{{ route('flowbite.playground.sidebar') }}"
