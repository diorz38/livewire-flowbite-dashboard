        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
                ...
                <a wire:navigate href="{{ route('dashboard') }}" class="flex ml-2 md:mr-24">
                    <img src="{{ asset('manpro8.svg') }}" class="h-10 mr-1" alt="Manpro Logo" />
                    <span
                    ...
                    <div>
                        <a wire:navigate href="#"
                            ...
                            <div class="flex-shrink-0">
                                ...
                                src="{{ asset('images/users/bonnie-green.png') }}" alt="Jese image">
                                <div
                        ...
                        <a wire:navigate href="#"
                            ...
                            <div class="flex-shrink-0">
                                <img class="rounded-full w-11 h-11"
                                src="{{ asset('images/users/jese-leos.png') }}" alt="Jese image">
                                <div
                        ...
                        <a wire:navigate href="#"
                            ...
                            <div class="flex-shrink-0">
                                <img class="rounded-full w-11 h-11"
                                src="{{ asset('images/users/joseph-mcfall.png') }}" alt="Joseph image">
                                <div
                        ...
                        <a wire:navigate href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-600">
                            <div class="flex-shrink-0">
                                <img class="rounded-full w-11 h-11"
                                src="{{ asset('images/users/robert-brown.png') }}" alt="Robert image">
                                <div
